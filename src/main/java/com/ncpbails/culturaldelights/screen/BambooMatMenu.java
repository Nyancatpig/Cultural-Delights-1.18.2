...
import com.ncpbails.culturaldelights.screen.slot.ModResultSlot;
...
public class BambooMatMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.BAMBOO_MAT.get());
    }
